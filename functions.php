...
function ls_cybersyn_help_overview_content() {
    $ret = '<h3>Αξιοποιήστε την δυνατότητα άντλησης και αναδημοσίευσης εξωτερικού περιεχομένου</h3>' .
            ...
            'Ανακαλύψτε στο διαδίκτυο επιλεγμένες ειδήσεις που θα θέλατε να αναδημοσιεύσετε. !!! <br/>
                    ...
                    Γίνετε θεματικός επιμελητής (content curation) του ιστολογίου σας.'
    //</p>'
    ;
    return $ret ;
}
